const CardSix = () => {
   ...
   */}
   ...
   <p className="text-title-md font-bold text-black dark:text-white">423</p>
        {/* </div> */}
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",textAlign:'center',marginTop:"10px",padding:'15px',border:'2px solid rgb(70,128,255)',borderRadius:"10px"}} >
                 <div>
