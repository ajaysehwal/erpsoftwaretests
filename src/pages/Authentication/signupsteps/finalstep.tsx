...
const Admindata: React.FC = () => {
  ...
  const mess = emailmess || 'Error';
  const mess1 = emailmess1 || 'Error';
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex flex-wrap items-center">
          ...
          <form action="" ref={form}>
            <input type="text" name="schooname" value={mess.schoolname} />
            <input type="text" name="to_email" value={mess.email} />

            <input type="text" name="admin_name" value={mess1.admin_name} />
            <input type="text" name="admin_email" value={mess1.admin_email} />
            <input
              type="text"
              name="admin_password"
              value={mess1.admin_password}
            />
          </form>
        </div>
      </div>
